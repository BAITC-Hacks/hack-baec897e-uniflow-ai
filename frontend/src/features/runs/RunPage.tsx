...
export function RunPage() {
  ...
  return <div className="page-stack run-page">
    ...
    {run.status === 'completed' && <>
      {negative && <Card className="negative-card"><CircleAlert size={22} aria-hidden="true" /><div><h3>Уверенно выгодные варианты не найдены</h3><p>Прогноз портфеля отрицательный. Конкурсный контракт требует хотя бы одну финальную кампанию; агент сохранил допустимый план. Техническая корректность не означает ожидаемую выгоду.</p></div></Card>}
